...
SELECT ID, Start_Time, End_Time, StaffID, Price, DepartureCityID, DestinationCityID FROM tbl_Tours WHERE (ID = @ID)";
        ...
        public virtual int Fill(TourTracerDataSet6.tbl_ToursDataTable dataTable) {
        ...
        public virtual TourTracerDataSet6.tbl_ToursDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TourTracerDataSet6.tbl_ToursDataTable dataTable = new TourTracerDataSet6.tbl_ToursDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TourTracerDataSet6.tbl_ToursDataTable dataTable) {
