...
SELECT ID, FirstName, LastName, Email, PhoneNumber, Password, BirthDate, Role FROM tbl_Users WHERE (ID = @ID)";
        ...
        public virtual int Fill(TourTracerDataSet7.tbl_UsersDataTable dataTable) {
        ...
        public virtual TourTracerDataSet7.tbl_UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TourTracerDataSet7.tbl_UsersDataTable dataTable = new TourTracerDataSet7.tbl_UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TourTracerDataSet7.tbl_UsersDataTable dataTable) {
