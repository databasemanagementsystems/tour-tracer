...
SELECT ID, Start_Time, End_Time, StaffID, Price, CityID FROM tbl_Tours WHERE (ID = @ID)";
        ...
        public virtual int Fill(TourTracerDataSet4.tbl_ToursDataTable dataTable) {
        ...
        public virtual TourTracerDataSet4.tbl_ToursDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TourTracerDataSet4.tbl_ToursDataTable dataTable = new TourTracerDataSet4.tbl_ToursDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TourTracerDataSet4.tbl_ToursDataTable dataTable) {
